...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnMedia = QPushButton(self.groupBox_2)
        self.btnMedia.setObjectName(u"btnMedia")
        self.btnMedia.setGeometry(QRect(190, 50, 121, 41))
        icon9 = QIcon()
        icon9.addFile(u":/icons/images/icons/cil-file.png", QSize(), QIcon.Normal, QIcon.On)
        self.btnMedia.setIcon(icon9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnMedia.setText(QCoreApplication.translate("MainWindow", u"MEDIA", None))
